...
LUCAS: Copy this file to a different folder (I've a folder called "Development" outside energymodelsrecidinghorizon) and run it from there. Not sure how to implement this thing as a "test"
"""
